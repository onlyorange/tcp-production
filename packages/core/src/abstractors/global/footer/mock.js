...
export default {
  footer_top: {
    email_sms_signup: {
      ...
      text:
        'GET <span class="l-color-primary">$10 OFF</span> BY SIGNING UP FOR EMAIL OR TEXT',
    ...
    refer_a_fried: {
      ...
      text:
        'REFER A FRIEND AND EARN ANOTHER <span class="l-color-primary">$10</span>',
      target: ""
    },
    social_media_links: [
      {
        ...
        items: [
          {
            ...
            links: [
              ...
              {
                url:
                  "https://www.childrensplace.com/us/help-center/#returnExchangePolicyli",
                text: "Return Policy",
        ...
        items: [
          {
            ...
            links: [
              ...
              {
                url:
                  "https://www.childrensplacemomspace.com/Portal/default.aspx",
                text: "The Mom Space",
        ...
        items: [
          {
            ...
            links: [
              {
                url:
                  "https://corporate.childrensplace.com/corporate-responsibility",
  ...
  footer_bottom: {
    copyrights: {
      text:
        "<p>&copy; 2019 The Children's Place | Big fashion, little prices</p>"
    },
    legal_links: [
      {
        url:
          "https://www.childrensplace.com/us/help-center/#termsAndConditionsli",
      ...
      {
        url:
          "https://www.childrensplace.com/us/help-center/#privacyPolicySectionli",
      ...
      {
        url:
          "https://www.childrensplace.com/us/help-center/#cookiePolicySectionli",
