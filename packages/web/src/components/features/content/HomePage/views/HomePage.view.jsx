  ...
  return (
    <Fragment>
      ...
      {layoutItems.val.map(item => (
        <Fragment>
          {item.val.typ === "module" && item.val.sub === "moduleA" ? (
            <div>module A</div>
          ) : (
            ""
          )}
          {item.val.typ === "module" && item.val.sub === "moduleB" ? (
            <div>module B</div>
          ) : (
            ""
          )}
          {item.val.typ === "module" && item.val.sub === "moduleD" ? (
            <ModuleD />
          ) : (
            ""
          )}
          {item.val.typ === "module" && item.val.sub === "moduleK" ? (
            <div>module K</div>
          ) : (
            ""
          )}
